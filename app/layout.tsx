...
export const metadata: Metadata = {
  ...
  description:
    'Studio privé de massage et de rituels de bien-être à Paris, dans l’esprit du hammam et de l’héritage arabo-andalou. Séances sur rendez-vous, dans un espace intimiste.',
