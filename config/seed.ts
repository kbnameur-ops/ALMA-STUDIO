...
export const seedServices: Service[] = [
  ...
  },
  {
    ...
    imageUrl: '/images/services/espagnol-evasion.jpg',
    imageAlt: 'Séance de massage du dos dans une alcôve de pierre éclairée à la bougie, ouverte sur un patio.',
    homeServiceAvailable: true,
    isActive: true,
    isSignature: true,
    sortOrder: 2,
  ...
  },
  {
    ...
    imageUrl: '/images/services/dos-nuque.jpg',
    imageAlt: 'Pression appuyée à la base de la nuque et sur le trapèze, serviettes roulées en arrière-plan.',
  ...
  },
  {
    ...
    imageUrl: '/images/services/sport-recovery.jpg',
    imageAlt: 'Massage de récupération du mollet, gestuelle appuyée, après l’effort.',
    homeServiceAvailable: true,
    isActive: true,
    isSignature: false,
    sortOrder: 5,
