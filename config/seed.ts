...
export const seedServices: Service[] = [
  ...
  },
  {
    ...
    imageUrl: '/images/services/espagnol-evasion-2.jpg',
    imageAlt: 'Massage du dos complet au studio, mains à plat le long de la colonne, bougies allumées autour de la table.',
    homeServiceAvailable: true,
    isActive: true,
    isSignature: true,
    sortOrder: 2,
