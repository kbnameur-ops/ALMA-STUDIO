...
export function LegalPage({
  ...
  return (
    <Section tone="ink" spacing="lg" className="pt-32 sm:pt-40" containerWidth="narrow">
      ...
      <p className="mt-4 font-body text-xs text-ivory-55">Dernière mise à jour : {updatedAt}</p>

      <div className="mt-12 space-y-10 font-body text-sm leading-relaxed text-ivory-70 [&_h2]:font-body [&_h2]:text-[0.7rem] [&_h2]:uppercase [&_h2]:tracking-[0.2em] [&_h2]:text-champagne [&_h2+p]:mt-3 [&_h2+ul]:mt-3 [&_li]:mt-1 [&_p+p]:mt-3 [&_ul]:list-disc [&_ul]:pl-5">
        {children}
      </div>
    </Section>
  );
