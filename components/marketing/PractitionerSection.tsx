...
export function PractitionerSection() {
  return (
    <Section tone="ink" spacing="lg" containerWidth="wide" aria-labelledby="praticien-titre">
      <div className="grid items-center gap-14 lg:grid-cols-[minmax(0,0.72fr)_minmax(0,1fr)] lg:gap-24">
        <Arch className="relative aspect-3/4 w-full">
          <PlaceholderImage
            src="/images/equipe/praticien-2.jpg"
        ...
        id="praticien-titre"
          ...
          <Reveal delay={0.12}>
            <p className="mt-8 font-heading text-2xl font-light text-ivory">
              {site.practitioner.name}
            </p>

            <div className="mt-7 space-y-6 font-body text-sm leading-relaxed text-ivory-70">
              ...
              <div className="border-l border-champagne/50 pl-5">
                ...
                <p className="mt-2 font-heading text-xl font-light italic leading-snug text-ivory">
                ...
                <ul className="mt-4 space-y-5">
                  {site.practitioner.training.map((school) => (
                    <li key={school.school}>
                      <p className="font-heading text-lg font-light leading-snug text-ivory">
                        {school.school}
                      </p>
                      <p className="mt-1 font-body text-xs uppercase tracking-[0.16em] text-ivory-55">
                        {school.city}
                      </p>
